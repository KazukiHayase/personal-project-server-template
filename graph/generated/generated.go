...
import (
	...
	"github.com/KazukiHayase/server-template/graph/gqlmodel"
...
var sources = []*ast.Source{
	{Name: "../schema/pagination.graphqls", Input: `scalar Cursor
...
func (ec *executionContext) _Query_sample(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNSample2githubᚗcomᚋKazukiHayaseᚋserverᚑtemplateᚋmodelᚐSample(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNSample2githubᚗcomᚋKazukiHayaseᚋserverᚑtemplateᚋmodelᚐSample(ctx context.Context, sel ast.SelectionSet, v model.Sample) graphql.Marshaler {
